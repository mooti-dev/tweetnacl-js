namespace tweetnaclAuth {
    ...
    function ts64(x:Uint8Array, i:number, u:u64) {
        x[i] = (u.hi >> 24) & 0xff;
        x[i + 1] = (u.hi >> 16) & 0xff;
        x[i + 2] = (u.hi >> 8) & 0xff;
        x[i + 3] = u.hi & 0xff;
    ...
    function A(o:gf, a:gf, b:gf) {
        var i;
        for (i = 0; i < 16; i++) o[i] = (a[i] + b[i]) | 0;
    }

    function Z(o:gf, a:gf, b:gf) {
        var i;
        for (i = 0; i < 16; i++) o[i] = (a[i] - b[i]) | 0;
    }

    function M(o:gf, a:gf, b:gf) {
    ...
    export function crypto_sign(sm:Uint8Array, m:Uint8Array, n:number, sk:Uint8Array) {
        var d = new Uint8Array(64),
            h = new Uint8Array(64),
            r = new Uint8Array(64);
    ...
    export function crypto_sign_open(m:Uint8Array, sm:Uint8Array, n:number, pk:Uint8Array) {
        var i:number, mlen:number;
